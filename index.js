...
const resetLeaderBoard = (id) => {
	...
	document.getElementById(td5).innerText = leaderBoard[0].id;
	document.getElementById(td6).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td7).innerText = leaderBoard[0].id;
	document.getElementById(td8).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td9).innerText = leaderBoard[0].id;
	document.getElementById(td10).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td11).innerText = leaderBoard[0].id;
	document.getElementById(td12).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td13).innerText = leaderBoard[0].id;
	document.getElementById(td14).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td15).innerText = leaderBoard[0].id;
	document.getElementById(td16).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td17).innerText = leaderBoard[0].id;
	document.getElementById(td18).innerText = leaderBoard[0].iterationCount;
	document.getElementById(td19).innerText = leaderBoard[0].id;
	document.getElementById(td20).innerText = leaderBoard[0].iterationCount;
